...
[![Video Presentation](https://img.youtube.com/vi/fo7SDBQ5WX0/0.jpg)](https://www.youtube.com/watch?v=fo7SDBQ5WX0)
...
```
김동현, 수리데이터사이언스학과(2021039698)
       깃헙 블로그 생성 및 작성, 데이터 전처리

이동헌, 컴퓨터학부(2023064311)
       Random Forest 기반 모델 실험, PHA 분류 결과 분석

이준하, 차세대반도체융합공학부(2026085050)
       NASA/JPL 데이터 수집, feature 분석

피소유, 인공지능학과(2023072597)
       딥러닝 기반 모델 실험, 모델 성능 비교 검토
